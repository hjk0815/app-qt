	...
	*/
	...
	var CONSTANTS = {
	  ...
	  4: {
	    iconsPrefix: 'glyphicon',
	    icons: {
	      paginationSwitchDown: 'glyphicon-arrow-down',
	      paginationSwitchUp: 'glyphicon-arrow-up',
	      refresh: 'glyphicon-refresh',
	      toggleOff: 'glyphicon-star',
	      toggleOn: 'glyphicon-star-empty',
	      columns: 'glyphicon-list',
	      detailOpen: 'glyphicon-plus',
	      detailClose: 'glyphicon-minus',
	      fullscreen: 'glyphicon-download-alt',
	      search: 'glyphicon-search',
	      clearSearch: 'glyphicon-trash'
	    },
	    classes: {
